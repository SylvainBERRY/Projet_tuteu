	...
	<div id="contenu">
		...
		<form name="inscription" id="inscription" action="index.php?action=connexion" method="post">
			<fieldset><legend>Identifiants</legend>
				<label for="login" class="float">Login :</label> <input type="text" name="login" id="login" size="30" /> <em>(compris entre 3 et 32 caractères)</em><br />
				<label for="nom" class="float">Nom :</label> <input type="text" name="nom" id="nom" size="30" /> <em>(compris entre 3 et 32 caractères)</em><br />
				<label for="prenom" class="float">Prenom :</label> <input type="text" name="prenom" id="prenom" size="30" /> <em>(compris entre 3 et 32 caractères)</em><br />
