...
if (isset($_POST['users_id_uti']))
{
	...
	if (empty($errors_array))
	{
		...
		// résultat
		$array_result = array();
		$array_result['message'] = "Les utilisateurs ont bien été validés.";
	...
	// Si un problème est survenu
		...
		$array_result = array();
		$array_result['message'] = "Une erreur est survenue, les utilisateurs suivants n'ont pas été validés.";
